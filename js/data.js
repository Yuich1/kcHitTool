  ...
  },
  {
    ...
    remodel: [
      ...
      },
      {
        ...
        luck: 8,
        slot: 3,
        specialCanHaveItemType: [8, 15, 29],
        fuel: 120,
        bullet: 20,
      },
    ],
...
const ITEM_DATA = [
...

  {
    ...
    singleBonus: [{ power: 2, targetId: [566, 567, 568] }],
    multiBonus: [
      {
        // C砲改二2積み
        power: 3,
        targetId: [566, 567, 568],
        isBonus: function (slotNumber) {
          let c = 0;
          if (slotNumber == 0) {
            return false;
  ...
  },
  {
    ...
    singleBonus: [
      ...
      { power: 3, targetId: [118, 119, 641, 702] },
    ],
    multiBonus: [
      //水上電探
      {
